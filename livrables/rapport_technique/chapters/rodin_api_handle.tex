...
Ne disposant pas du code source de la classe \javacode{Platform.getOS}, nous pouvons malgré tout inspecter le bytecode associé.
...
Si l'on s'intéresse maintenant à la méthode d'instance \javacode{InternalPlatform.getOS}, le bytecode est le suivant~:
