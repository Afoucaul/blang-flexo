\chapter{Écriture d'un plugin de test pour Rodin}

Nous nous proposons dans un premier temps de procéder à l'implémentation d'un plugin élémentaire pour Rodin, dans le but de nous familiariser avec son API.
...
\section{Écriture d'un plugin de base}
...
\section{Intégration dans Rodin}
...
\section{Appels à l'API de Rodin}
